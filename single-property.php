        ...
        <div class="property-header">
            <div class="d-flex justify-content-between align-items-end mb-3">
                ...
                <div class="d-flex gap-3">
                    <button class="btn btn-link text-dark text-decoration-underline fw-bold p-0" onclick="shareLink('<?php echo addslashes($propertyData['title']); ?>', 'Check out this property on 2nd Home!')"><i class="fa-solid fa-share-nodes me-2"></i>Share</button>
